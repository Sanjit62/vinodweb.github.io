document.addEventListener("DOMContentLoaded", function(){ jQuery(document).ready(function () {
				let scope = jQuery(".wp-block-uagb-image-gallery.uagb-block-76526d58");
				if ( scope.length ) { 
				...
				let scope = jQuery(".wp-block-uagb-image-gallery.uagb-block-55121df3");
				if ( scope.length ) { 
					scope.css("visibility", "visible");
					let getSlickCarousel = scope.find(".uagb-slick-carousel");
					if( getSlickCarousel.length ) {
				...
				let scope = jQuery(".wp-block-uagb-image-gallery.uagb-block-72ace107");
				if ( scope.length ) { 
					scope.css("visibility", "visible");
					let getSlickCarousel = scope.find(".uagb-slick-carousel");
					if( getSlickCarousel.length ) {
